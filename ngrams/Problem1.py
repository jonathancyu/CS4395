...
def main():
    ...
    pickle.dump(eng_uni_dict, open('eng_bi_dict.p', 'wb'))
    pickle.dump(french_uni_dict, open('french_uni_dict.p', 'wb'))
    pickle.dump(french_uni_dict, open('french_bi_dict.p', 'wb'))
    pickle.dump(italian_uni_dict, open('italian_uni_dict.p', 'wb'))
    pickle.dump(italian_uni_dict, open('italian_bi_dict.p', 'wb'))
    return
